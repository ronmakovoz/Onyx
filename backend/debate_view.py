...
as a self-contained Linx-branded page (no frontend framework required).
"""
...
<body><div class="wrap">
  <div class="topbar">
    <div>
      <div class="brand"><span class="logo">LINX</span><span class="sub">CX AGENT OS · RED TEAM DEBATE</span></div>
  ...
  <div class="footer">Generated by Linx CX Agent OS · Multi-agent adversarial debate · Bull + Bear ran in parallel (Sonnet), Synthesis judged (Opus)</div>
</div></body></html>"""
...
<body><div class="wrap"><div class="center">
  <div class="brand" style="justify-content:center"><span class="logo">LINX</span><span class="sub">CX AGENT OS</span></div>
