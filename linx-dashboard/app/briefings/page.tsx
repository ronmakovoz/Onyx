...
export default function BriefingsPage() {
  ...
  return (
    <div>
      <PageHeader title="Executive Briefings" subtitle="CISO-ready account narratives and a weekly VP Customer Success review" />
