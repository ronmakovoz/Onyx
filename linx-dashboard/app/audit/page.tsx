  ...
  return (
    <div>
      ...
      <div className="audit-grid">
        <section><SectionTitle>Model routing</SectionTitle><div className="card routing-card"><div><span><i style={{ background: "#2f8cff" }} />Sonnet</span><b>82%</b><small>Complex account analysis and briefings</small></div><div><span><i style={{ background: "#161616" }} />Opus</span><b>12%</b><small>Portfolio synthesis and Skeptik QA</small></div><div><span><i style={{ background: "#43c7a0" }} />Haiku</span><b>6%</b><small>Fast remediation and next-action drafts</small></div></div></section>
        <section><SectionTitle>Governance controls</SectionTitle><div className="card controls-card"><div><span>✓</span><p><strong>Account-scoped context</strong>Agents receive only the selected customer record.</p></div><div><span>✓</span><p><strong>Full run trace</strong>Model, tokens, cost, confidence, and output are logged.</p></div><div><span>✓</span><p><strong>Synthetic demo data</strong>No production customer or identity records are present.</p></div></div></section>
      </div>
