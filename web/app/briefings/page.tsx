          ...
          <div className="flex gap-3 items-center flex-wrap mb-4">
            ...
            {ceo && !ceo.error ? (
              <button
                onClick={() => run("skeptik")}
                disabled={busy !== null}
                className="bg-white text-navy border-[1.5px] border-[#D0CADE] rounded-full px-5 py-2 text-[0.78rem] font-semibold hover:bg-[#F0ECE8] disabled:opacity-60"
              >
      ...
      {tab === "VP Weekly Review" && (
        <div>
          <button
            onClick={() => run("vp")}
            disabled={busy !== null}
            className="bg-navy text-white rounded-full px-5 py-2 text-[0.78rem] font-semibold hover:bg-[#2D1A5E] disabled:opacity-60 mb-4"
          >
