...
INDUSTRIES = {
    ...
    "Insurance": ["AI agent governance", "data governance", "cloud security"],
    "Technology": ["DevSecOps", "secrets management", "shadow AI discovery"],
    ...
    "Retail": ["PCI compliance", "prompt-injection defense", "mobile security"],
...
TICKET_TITLES = [
    ...
    "CNAPP discovery-source integration broken after update",
